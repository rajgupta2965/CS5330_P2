...
// runs an image through ResNet18 and returns the 512-dim embedding
...
int main(int argc, char *argv[]) {
    ...
    // write one row per image: filename, then 512 embedding values
    ...
    csv_file.close();
    std::cout << "Embeddings saved to " << output_csv << std::endl;
